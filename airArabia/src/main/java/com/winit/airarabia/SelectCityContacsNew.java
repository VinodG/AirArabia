...
import com.winit.airarabia.adapters.CityAdapterContactsNew;
import com.winit.airarabia.objects.CountriesDO;

public class SelectCityContacsNew extends BaseActivity{

	private LinearLayout llSelectCurrency;
	private ListView list;
	private CityAdapterContactsNew countryAdapter;
...
//	private ArrayList<CountriesDO> vecCountry;\
	...
	public void initilize() {
		...
		tvSelectCurrencyTitle.setText(getString(R.string.selectCity));
...
//			vecCountry.add((CountriesDO) getIntent().getSerializableExtra("countryDO"));
			...
			countryDO=(CountriesDO) getIntent().getSerializableExtra("countryDO");
		}
...
//		AppConstants.allAirportsDO.vecAirport.remove(0);
			...
			countryAdapter = new CityAdapterContactsNew(SelectCityContacsNew.this, countryDO.vecCityDO,countryNameToCompare,list,tvNoItem);
