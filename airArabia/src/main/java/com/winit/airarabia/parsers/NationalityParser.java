...
public class NationalityParser extends BaseHandler{
	...
	public void startElement(String uri, String localName, String qName,Attributes attributes) throws SAXException {
		...
		if(localName.equalsIgnoreCase("Countries"))	//	GetNationalitiesResult
		...
		else if(localName.equalsIgnoreCase("Country"))
		{
			...
			if(objcountryDO.CountryName.equalsIgnoreCase("(DR) Congolese")){
				objcountryDO.CountryName = "Congolese (DR)";
			}
		}
	}
