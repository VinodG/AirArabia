...
public class EditSavedPassengerActivity extends BaseActivity {
	...
	private Vector<SavedPassengerDO> tempVecSavedPassengerDo = new Vector<SavedPassengerDO>();
	...
	public void initilize() {
		...
		adapter = new EditPassengerAdapter(vecSavedPassengerDo); 
		bindingControl();
	}
	...
	public void bindingControl() {
		...
		listView.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> arg0, View view, int pos,
					long arg3) {
				SavedPassengerDO objSavedPass = vecSavedPassengerDo.get(pos);
				DeleteObjectFromVector(objSavedPass, adapter);
			}
		});
	...
	class EditPassengerAdapter extends BaseAdapter
	{
		private Vector<SavedPassengerDO> vecSavedPassengerDo;
		public EditPassengerAdapter(Vector<SavedPassengerDO> vecSavedPassengerDo) {
		...
		public View getView(int position, View convertView, ViewGroup arg2) {
			...
			if (convertView == null) {
				...
				convertView = inflater.inflate(R.layout.edit_saved_passanger_item, null);
			...
			tvTitleItem.setOnClickListener(new OnClickListener() {
				...
				public void onClick(View v) {
					if(!(tvTitleItem.getText().toString()).equalsIgnoreCase("")){
						Intent i = new Intent(EditSavedPassengerActivity.this, AddNewPassenger.class);
//						i.addFlags(Intent.FLAG_ACTIVITY_NO_HISTORY);
	...
	private void DeleteObjectFromVector(SavedPassengerDO objSavedPass, EditPassengerAdapter adapter)
	{
		otherPassengerDo = gettingObjecFromSharedPrerenceOtherPassengerDo(SharedPreferenceStrings.otherPassengerDo);
		for (int i = 0; i < otherPassengerDo.vecSavedPassengerDoAdult.size(); i++) {
			if(otherPassengerDo.vecSavedPassengerDoAdult.get(i).firstName.equals(objSavedPass.firstName)
					&& otherPassengerDo.vecSavedPassengerDoAdult.get(i).lastName.equals(objSavedPass.lastName))
				otherPassengerDo.vecSavedPassengerDoAdult.remove(i);
		}
		
		for (int i = 0; i < otherPassengerDo.vecSavedPassengerDoChild.size(); i++) {
			if(otherPassengerDo.vecSavedPassengerDoChild.get(i).firstName.equals(objSavedPass.firstName)
					&& otherPassengerDo.vecSavedPassengerDoChild.get(i).lastName.equals(objSavedPass.lastName))
				otherPassengerDo.vecSavedPassengerDoChild.remove(i);
		}
		
		for (int i = 0; i < otherPassengerDo.vecSavedPassengerDoInfant.size(); i++) {
			if(otherPassengerDo.vecSavedPassengerDoInfant.get(i).firstName.equals(objSavedPass.firstName)
					&& otherPassengerDo.vecSavedPassengerDoInfant.get(i).lastName.equals(objSavedPass.lastName))
				otherPassengerDo.vecSavedPassengerDoInfant.remove(i);
		}
		
		this.vecSavedPassengerDo.remove(objSavedPass);
